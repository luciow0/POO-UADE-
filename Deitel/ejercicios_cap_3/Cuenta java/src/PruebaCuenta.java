...
public class PruebaCuenta
{
    public static void main(String [] args)
    {
       ...
       // System.out.printf("el nombre en el objeto mi cuenta es: %n%s%n", miCuenta.obtenerNombre());
        ...
        Cuenta cuenta1 = new Cuenta("Pablo cuello");
        Cuenta cuenta2 = new Cuenta("Celeste amarillo");

        System.out.printf("El nombre de cuenta1 es: %s%n", cuenta1);
        System.out.printf("El nombre de cuenta1 es: %s%n", cuenta2);
